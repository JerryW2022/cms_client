...
export default function ProductHome() {
  ...
  //第一个参数是一个回调函数，用于进行需要进行 memoization（记忆化）的计算逻辑。第二个参数是一个依赖数组，用于指定在依赖项发生变化时，才重新执行回调函数进行计算。如果依赖项数组为空，则回调函数只会在组件首次渲染时执行一次。
  ...
  //     } else {
  //       // 一般分页请求
  //       result = await reqProducts(pageNum, PAGE_SIZE); //page_size每页条数
  //     }
  ...
  //   },
  //   [searchKeyword, searchType, setTotal, setProducts, setLoading]
  // );
